      ...
      <div className={`${isHome ? 'bg-[#9538E2] rounded-[32px] pb-60 text-white relative' : 'text-black'}`}>
        ...
        <nav className="flex justify-between items-center px-10 py-2 max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex gap-8 font-medium">
            <Link 
              href="/" 
              className={pathname === '/' ? "text-white border-b-2 font-bold" : "opacity-80 hover:opacity-100 font-bold"}
            >
              Home
            </Link>
            <Link 
              href="/statistics" 
              className={pathname === '/statistics' ? "text-[#9538E2] border-b-2 border-[#9538E2] font-bold" : "opacity-80 hover:opacity-100 font-bold"}
            >
              Statistics
            </Link>
            <Link 
              href="/dashboard" 
              className={pathname === '/dashboard' ? "text-[#9538E2] border-b-2 border-[#9538E2] font-bold" : "opacity-80 hover:opacity-100 font-bold"}
            >
              Dashboard
            </Link>
          </div>
        ...
        {isHome && (
          <>
            <div className="flex flex-col items-center text-center mt-16 px-6">
              ...
              <button className="mt-10 bg-white text-[#9538E2] font-bold px-10 py-4 rounded-full text-lg shadow-xl hover:bg-black hover:text-white transition cursor-pointer">
                Shop Now
              </button>
            </div>
