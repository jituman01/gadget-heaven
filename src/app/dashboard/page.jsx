...
export default function Dashboard() {
  ...
  const { cart, wishlist, removeFromCart, removeFromWishlist, addToCart } = useCart();
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <button
                  ...
                  className="border-2 border-[#9538E2] text-[#9538E2] px-6 py-2.5 rounded-full font-bold hover:bg-purple-50 transition flex items-center gap-2"
                >
                ...
                <button className="bg-[#9538E2] text-white px-8 py-2.5 rounded-full font-bold">
                  Purchase
                </button>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {displayCart.length > 0 ? (
                displayCart.map((item, index) => (
                  <div key={`${item.product_id}-${index}`} className="bg-white p-6 rounded-2xl flex items-center gap-8 shadow-sm border relative">
                    ...
                    <button
                      ...
                      className="absolute top-6 right-6 text-red-500 text-3xl hover:scale-110 transition"
                    >
                ...
                <div key={`${item.product_id}-${index}`} className="bg-white p-6 rounded-2xl flex items-center gap-8 shadow-sm border relative">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      className="bg-[#9538E2] text-white px-8 py-2 rounded-full font-bold hover:bg-purple-700 transition"
                    >
                      Add to Cart
                    </button>
                  </div>
